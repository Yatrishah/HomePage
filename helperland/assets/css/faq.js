        ...
        $(document).ready(function () {
            ...
            $(".collapse.show").each(function () {
                $(this).prev(".question").find("img").attr('src', "../assets/image/arrow-down.png");
            });

            // Toggle right and down arrow icon on show hide of collapse element
            $('.btn-col').on('click', function () {
                if ($(this).parent().parent().find(".collapse.show").length) {
                    $(this).children('img').attr('src', "../assets/image/arrow-right.png");
                } else {
                    $(this).children('img').attr('src', "../assets/image/arrow-down.png");
                }
            });
