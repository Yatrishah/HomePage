...
<div class="header">  <p class="text1">Prices</p>  </div>  
...
<section class="container text-center " style="margin:auto;">
    ...
    <div class="row ">
        ...
        <div class="col-lg col-6 ">
         <div class=" circle "> <img src="../assets/image/extraservice1.png"> </div>
         <h2 class="servicetxt1" title="Inside cabinets">Inside cabinets</h2>
         <p class="servicetxt2">30 minutes </p>
          </div>
<div class="col-lg col-6 ">
         <div class=" circle "> <img src="../assets/image/extraservice2.png">  </div>
         <h2 class="servicetxt1" title="  Inside fridge  " >Inside fridge</h2>
         <p class="servicetxt2">30 minutes </p>
          </div>
    
     <div class="col-lg col-6 ">
         <div class=" circle "> <img src="../assets/image/extraservice3.png"style="margin-top:5px ;margin-left: -10px;">  </div>
 ...
 <div class="col-lg col-6 ">
         <div class=" circle "> <img src="../assets/image/extraservice4.png" >  </div>
         <h2 class="servicetxt1" title="Laundry wash & dry">Laundry wash & dry</h2>
         <p class="servicetxt2">30 minutes </p>
          </div>

          <div class="col-lg col-6 ">
         <div class=" circle "> <img src="../assets/image/extraservice5.png"style="margin-top:1px ;margin-left: -7px;">  </div>
 ...
 <section id="section-whyhelper">
            <div class="whyhelper">
                <div class="whyhelper-head" title=" Why Helperland  ">
            ...
            <div class="d-flex justify-content-center">
                         <a href="book-service.php" class="bookbutton " ><p class="booktext">Let's Book a Cleaner</p></a></div>
