                            ...
                            <div class="form">
                               ...
                               <!--   <h1 style=" margin: 0 auto; width: 400px;"><?= $output1; ?></h1>
                                 ...
                                 <div>
                                    ...
                                    <form  action="<?php echo 'http://localhost/project/?controller=Home&function=customerregistration';?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
         <?php 
